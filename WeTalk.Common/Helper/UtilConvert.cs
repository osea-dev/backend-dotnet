...
namespace WeTalk.Common
{
	...
	public static class UtilConvert
	{
		...
		/// <param name="errorValue"></param>
		/// <returns></returns>
		public static long ObjToLong(this object thisValue, long errorValue = 0)
		{
			long reval = 0;
		...
		/// <param name="thisValue"></param>
		/// <returns></returns>
		public static JObject ObjToJObject(this object thisValue)
		{
			JObject reval = new JObject();
			if (thisValue != null && thisValue != DBNull.Value)
			{
				reval = (JObject)thisValue;
			}
			return reval;
		}
